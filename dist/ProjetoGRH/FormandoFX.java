 ...
 */
public class FormandoFX extends BorderPane {
    ...
    public void janelaFormando() {
        ...
        l1 = new Label("1)\tAntes da formação, como avalia o seu desempenho? \n(0 - Péssimo a 5 - Excelente)");
        l2 = new Label("2)\tChefe apresentou algumas estratégias de apoio à máxima rentabilização dos saberes adquiridos?? \n(0 - Nenhuma a 5 - Bastantes)");
        l3 = new Label("3)\tDiante do feedback do chefe, como avaliaria a satisfação do chefe para com o seu desempenho na formação? \n(0 - Muito Insatisfeito a 5 - Muito Satisfeito)");
        l4 = new Label("4)\tO chefe demonstrou interesse pelas dificuldades dos formandos? \n(0 - Nunca a 5 - Sempre)");
